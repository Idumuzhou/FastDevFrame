...
import com.laoluo.fastdev.localretrofit.LocalRetrofit
import com.laoluo.fastdev.localretrofit.converter.JsonConverterFactory
import com.laoluo.fastdevcore.integration.http.GlobalHttpHandler
import com.laoluo.fastdevcore.integration.http.RequestInterceptor
import com.laoluo.fastdevcore.utils.makeDirs
            ...
            Kodein.Module(CLIENT_MODULE_TAG) {
                ...
                bind<LocalRetrofit>() with singleton {
                    instance<LocalRetrofit.Builder>()
                        ...
                        .addCallAdapterFactory(com.laoluo.fastdev.localretrofit.calladapter.RxJava2CallAdapterFactory.create())
